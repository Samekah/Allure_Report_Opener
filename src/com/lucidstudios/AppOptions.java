...
public class AppOptions {
    private final String APPCONFIGPATH = Thread.currentThread().getContextClassLoader().getResource("com/lucidstudios/config.properties").getPath().replace("%20", " ").substring(1);
